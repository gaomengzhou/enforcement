...
import DetailCommon1 from '../Workorder/Department/Inspectors/DetailCommon1';
import DetailCourse2 from '../Workorder/Department/Inspectors/DetailCourse2';
import DetailInformation3 from '../Workorder/Department/Inspectors/DetailInformation3';
import DetailDispose4 from '../Workorder/Department/Inspectors/DetailDispose4';
import DetailSecond5 from '../Workorder/Department/Inspectors/DetailSecond5';
import DetailInspect6 from '../Workorder/Department/Inspectors/DetailInspect6';
import DetailDelay7 from '../Workorder/Department/Inspectors/DetailDelay7';
...
class app extends PureComponent {
    ...
    if (key) {
      ...
      dispatch({
        ...
        callback: res => {
          if (res) {
            this.setState({ smallType: res.filter(item => item.code == dataSource.caseBigType) }, () => {
              this.getcaseSmallType(this.state.smallType && this.state.smallType[0].id)
            })
          }
        },
      });
  ...
  handleOk = type => {
    ...
    if (type == 'TGBH') {
      ...
      values.durationInspection && (dataSource.durationInspection = values.durationInspection);
      values.inspectionInterval && (dataSource.inspectionInterval = values.inspectionInterval);
      dispatch({
      ...
      <div id="listTitleContent">
        ...
        <div id="listTitleDetailTabEdit">
          <Form>
            ...
            <Row style={{ position: "absolute", right: '-51%', top: `60%`, width: '81%', display: this.state.tabKey === '2' ? 'none' : 'block' }}>
              <Col span={8}>
