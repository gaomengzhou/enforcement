...
class app extends PureComponent {
  ...
  renderAttachment() {
    ...
    const uploadButton = (
      <div>
        <Button
          style={{ position: "absolute", top: -6, left: 88 }}
  ...
  renderAttachmentTwo() {
    ...
    const uploadButton = (
      <div>
        <Button
          style={{ position: "absolute", top: -6, left: 108 }}
          className="ant-upload-text"
          disabled={
            info.status != "3" ||
            userRole != 4 ||
            info.isApplicationClosure != 0
          }
        >
          整改后
        </Button>
    ...
    return (
      <Fragment>
        <div className="clearfix">
          <Upload {...uploadProps}>
            {fileListTwo.length >= 10 ? null : uploadButton}
          </Upload>
          <Modal
            visible={previewVisible}
            footer={null}
      ...
      <Select
        ...
        value={
          unit
            ? unit
            : info.dispatchVos
            ? info.dispatchVos.length > 0
              ? info.dispatchVos[0].unit
              : "1"
            : "1"
        }
        style={{ width: 70 }}
          ...
          <Row>
            <Col span={16}>
              ...
              <div id="tableListForm" style={{ padding: "0 10px 0 0" }}>
                    ...
                    <Col span={12}>
                      ...
                      >
                        {getFieldDecorator("assistTime", {
                          ...
                          initialValue:
                            info.dispatchVos && info.dispatchVos[0]
                              ? info.dispatchVos[0].assistTime
                              : ""
                        })(
                          <Input
                            placeholder="请输入"
                    ...
                    <Col span={12}>
                      <FormItem label="所属社区">
                        {getFieldDecorator("ownCommunity", {
                          ...
                          <Select placeholder="请选择社区" disabled={flag != 1}>
                            {parentBank &&
                              parentBank.map(item => (
                                <Option value={item.code} key={item.code}>
                                  {item.desp}
                    ...
                    <Col span={12}>
                      <FormItem label="承办人员">
                        {getFieldDecorator(`executor`, {
                          ...
                          initialValue:
                            info.dispatchVos && info.dispatchVos[0]
                              ? Number(info.dispatchVos[0].executor)
                              : ""
                        })(
                          <Select placeholder="请选择" disabled={flag != 1}>
                            {executor &&
                ...
                <Row
                  gutter={{ xl: 10, xxl: 40 }}
                  hidden={info.isCheck == 0 || userRole != 2}
                >
                  <Col span={24}>
                    <Col span={12}>
                      <FormItem
